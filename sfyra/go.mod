...
replace (
	...
	k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20260512234627-ef417d054102
	...
	sigs.k8s.json => sigs.k8s.io/json v0.0.0-20250730193827-2d320260d730
)
...
require (
	...
	github.com/siderolabs/cluster-api-bootstrap-provider-talos v0.6.12 // indirect
